...
proj4.defs(ITM,"+proj=tmerc +lat_0=53.5 +lon_0=-8 +k=0.99982 +x_0=600000 +y_0=750000 +ellps=GRS80 +towgs84=0,0,0,0,0,0,0 +units=m +no_defs");
...
export const MarkerLayerWithTooltipReproject = ({ data }) => {
  ...
  return (
    <LayersControl.Overlay name="Irish cities reprojected">
      <LayerGroup zoomToBoundsOnClick={false}>
        {layer}
      </LayerGroup>
